<?php
/*
Plugin Name: Contact Form by UserPulse
Plugin URI: http://www.userpulse.com/
Description: Contact Form and Contact Us button by UserPulse
Author: Adi Ben-Ari
Version: 3.5
...
function getContactUsPlus()
{
  ...
  echo "<!--  UserPulse Toolbar WordPress Plugin 3.5 formid=".get_option('contactusplus_data')." username=".get_option('contactusplus_data_email')." --><script type='text/javascript'>
...
<td width='100%' style='font-size: 8pt;'>Provide an email address to receive completed forms.<br/>We will NOT pass on your email address, or send spam. <br/>See <a href='http://www.userpulse.com/content/privacy.jsp'>Privacy Policy</a> and <a href='http://www.userpulse.com/content/terms.jsp'>Terms of Use</a>.<br/>
</tr>
...
<tr><td></td><td style='font-size: 8pt;' colspan='2'>After saving, the Contact Us button/toolbar will be added to your site.<br/>We'll also create an account for your at <a href='http://www.userpulse.com/wordpress-contact-form.jsp'>userpulse.com</a>, so that you can change the design of your form and other settings - you'll receive an email with all the details.</td></tr>
</table>
